    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        body::before {
            ...
            inset: 0;
            background:
                radial-gradient(ellipse 80% 60% at 20% 50%, rgba(184,146,74,0.07) 0%, transparent 70%),
                radial-gradient(ellipse 60% 80% at 80% 30%, rgba(184,146,74,0.05) 0%, transparent 70%);
            pointer-events: none;
            z-index: 0;
        }
